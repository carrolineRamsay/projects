...
$ch2 = curl_init('http://api.geonames.org/countryInfoJSON?formatted=true&country=' . $rest['alpha2Code'] . '&username=taskpage&style=full;');
    ...
    curl_setopt_array($ch4, array(
        CURLOPT_URL => "https://geo-services-by-mvpc-com.p.rapidapi.com/cities/significant?pourcent=0.1&countrycode=" . $data['alpha2Code'] . "&limit=15&language=en",
    ...
    curl_setopt_array($ch6, array(
        ...
        CURLOPT_HTTPHEADER => array(
            ...
            "x-rapidapi-key: b2f5428d9c10a9ebe2a312eedf6e3628"
        ),
    ));
